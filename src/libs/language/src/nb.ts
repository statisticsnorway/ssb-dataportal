...
export const nb = {
  ...
  correspondences: {
    ...
    description:
      'Korrespondansetabellene viser sammenhengen mellom versjoner eller ulike kodeverk. Velg en tabell for å se hvilke koder som tilsvarer hverandre.',
    tableDescription: 'Korrespondansetabell mellom kodeverkene.',
    changeTable: 'Endringstabell som viser sammenhengen mellom versjonene.',
    empty: 'Det finnes ingen korrespondansetabeller for denne versjonen.',
    from: 'Korrespondanser fra',
    to: 'Korrespondanser til',
    level: 'Nivå',
    owner: 'Eier',
    detail: {
      back: 'Til korrespondanser',
      heading: 'Korrespondanse',
      description: 'Korrespondansen viser hvilke koder som tilsvarer hverandre i de to kodeverkene.',
      filterLabel: 'Filtrer etter kode eller navn',
      filterPlaceholder: 'Søk etter kode eller navn',
      empty: 'Ingen korrespondanser samsvarer med filteret.',
