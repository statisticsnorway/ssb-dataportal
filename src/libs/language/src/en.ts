...
export const en = {
  ...
  correspondences: {
    ...
    description:
      'The correspondence tables show the relationship between versions or different code lists. Select a table to see which codes correspond to each other.',
    tableDescription: 'Correspondence table between the code lists.',
    changeTable: 'Change table showing the relationship between the versions.',
    empty: 'There are no correspondence tables for this version.',
    from: 'Correspondences from',
    to: 'Correspondences to',
    level: 'Level',
    owner: 'Owner',
    detail: {
      back: 'Back to correspondences',
      heading: 'Correspondence',
      description: 'The correspondence shows which codes correspond to each other in the two code lists.',
      filterLabel: 'Filter by code or name',
      filterPlaceholder: 'Search by code or name',
      empty: 'No correspondences match the filter.',
