...
export const nn = {
  ...
  classification: {
    ...
    correspondence: {
      ...
      noFilterResults: 'Ingen korrespondansar samsvarar med filteret.',
    },
    variant: {
      name: 'Namn',
      id: 'ID',
  ...
  error: {
    ...
    notFoundTitleVersionDetails: 'Versjon ikkje funnen',
    notFoundMessageVersionDetails: 'Er det skrivefeil i lenkja? Eller har versjonen blitt sletta eller flytta?',
    notFoundHelpListVersionDetails: [
      'sjekke at du har riktig versjons-id i lenkja',
      'gå tilbake til klassifikasjonen',
      'gå til oversikta over klassifikasjonar',
    ],
    notFoundTitleVariantDetails: 'Variant ikkje funnen',
    notFoundMessageVariantDetails: 'Er det skrivefeil i lenkja? Eller har varianten blitt sletta eller flytta?',
    notFoundHelpListVariantDetails: [
      'sjekke at du har riktig variant-id i lenkja',
      'gå til oversikta over variantar',
      'gå til oversikta over klassifikasjonar',
    ],
    notFoundTitleCorrespondenceDetails: 'Korrespondanse ikkje funnen',
    notFoundMessageCorrespondenceDetails:
      'Er det skrivefeil i lenkja? Eller har korrespondansen blitt sletta eller flytta?',
    notFoundHelpListCorrespondenceDetails: [
      'sjekke at du har riktig korrespondanse-id i lenkja',
