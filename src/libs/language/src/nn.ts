...
export const nn = {
  ...
  correspondences: {
    ...
    description:
      'Korrespondansetabellane viser samanhengen mellom versjonar eller ulike kodeverk. Vel ein tabell for å sjå kva for kodar som svarar til kvarandre.',
    tableDescription: 'Korrespondansetabell mellom kodeverka.',
    changeTable: 'Endringstabell som viser samanhengen mellom versjonane.',
    empty: 'Det finst ingen korrespondansetabellar for denne versjonen.',
    from: 'Korrespondansar frå',
    to: 'Korrespondansar til',
    level: 'Nivå',
    owner: 'Eigar',
    detail: {
      back: 'Til korrespondansar',
      heading: 'Korrespondanse',
      description: 'Korrespondansen viser kva for kodar som svarar til kvarandre i dei to kodeverka.',
      filterLabel: 'Filtrer etter kode eller namn',
      filterPlaceholder: 'Søk etter kode eller namn',
      empty: 'Ingen korrespondansar samsvarar med filteret.',
      sourceCode: 'Kjeldekode',
      sourceName: 'Kjeldenamn',
      targetCode: 'Målkode',
      targetName: 'Målnamn',
      contact: 'Ansvarleg',
