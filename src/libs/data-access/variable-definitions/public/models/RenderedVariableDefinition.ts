...
export function instanceOfRenderedVariableDefinition(value: object): value is RenderedVariableDefinition {
  ...
  if (
    !('containsSpecialCategoriesOfPersonalData' in value) ||
    value['containsSpecialCategoriesOfPersonalData'] === undefined
  )
    return false;
...
export function RenderedVariableDefinitionFromJSONTyped(
  json: any,
  ...
  return {
    ...
    relatedVariableDefinitionUris:
      json['related_variable_definition_uris'] == null ? undefined : json['related_variable_definition_uris'],
...
export function RenderedVariableDefinitionToJSONTyped(
  value?: RenderedVariableDefinition | null,
