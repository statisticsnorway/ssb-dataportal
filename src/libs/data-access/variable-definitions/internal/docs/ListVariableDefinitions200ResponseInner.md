...
**name** | **string** | Name of the variable. Must be unique for a given Unit Type and Owner combination. | [default to undefined]
**short_name** | **string** | Recommended short name. Must be unique within an organization. | [default to undefined]
**definition** | **string** | Definition of the variable. | [default to undefined]
...
**unit_types** | [**Array&lt;RenderedViewUnitTypesInner&gt;**](RenderedViewUnitTypesInner.md) | A list of one or more unit types, e.g. person, vehicle, household. Must be defined as codes from https://www.ssb.no/klass/klassifikasjoner/702. | [default to undefined]
**subject_fields** | [**Array&lt;RenderedViewUnitTypesInner&gt;**](RenderedViewUnitTypesInner.md) | A list of subject fields that the variable is used in. Must be defined as codes from https://www.ssb.no/klass/klassifikasjoner/618. | [default to undefined]
...
**measurement_type** | [**RenderedViewMeasurementType**](RenderedViewMeasurementType.md) |  | [optional] [default to undefined]
...
**comment** | **string** | Optional comment to explain the definition or communicate potential changes. | [optional] [default to undefined]
...
**contact** | [**RenderedViewContact**](RenderedViewContact.md) |  | [default to undefined]
...
**classification_uri** | **string** | Link to the classification which defines all permitted values for this variable. | [optional] [default to undefined]

## Example

```typescript
import { ListVariableDefinitions200ResponseInner } from './api';

const instance: ListVariableDefinitions200ResponseInner = {
    id,
    patch_id,
    name,
    short_name,
