...
**name** | **string** | Name of the variable. Must be unique for a given Unit Type and Owner combination. | [optional] [default to undefined]
**short_name** | **string** | Recommended short name. Must be unique within an organization. | [default to undefined]
**definition** | **string** | Definition of the variable. | [optional] [default to undefined]
...
**contact** | [**RenderedViewContact**](RenderedViewContact.md) |  | [optional] [default to undefined]
...
```typescript
import { RenderedView } from './api';

const instance: RenderedView = {
    id,
    patch_id,
    name,
    short_name,
