 ...
 * @export
 * @interface CompleteResponseOwner
 */
export interface CompleteResponseOwner {
    /**
     * The Dapla team with responsibility for this variable definition.
     * @type {string}
     * @memberof CompleteResponseOwner
     */
    team: string;
    /**
...
/**
 * Check if a given object implements the CompleteResponseOwner interface.
 */
export function instanceOfCompleteResponseOwner(value: object): value is CompleteResponseOwner {
    if (!('team' in value) || value['team'] === undefined) return false;
    if (!('groups' in value) || value['groups'] === undefined) return false;
    return true;
}

export function CompleteResponseOwnerFromJSON(json: any): CompleteResponseOwner {
    return CompleteResponseOwnerFromJSONTyped(json, false);
}

export function CompleteResponseOwnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): CompleteResponseOwner {
    if (json == null) {
        return json;
    }
    return {
...
export function CompleteResponseOwnerToJSON(json: any): CompleteResponseOwner {
    return CompleteResponseOwnerToJSONTyped(json, false);
}

export function CompleteResponseOwnerToJSONTyped(value?: CompleteResponseOwner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
