...
/**
 * Check if a given object implements the PatchDefinition interface.
 */
export function instanceOfPatchDefinition(value: object): value is PatchDefinition {
    return true;
}

export function PatchDefinitionFromJSON(json: any): PatchDefinition {
    return PatchDefinitionFromJSONTyped(json, false);
}

export function PatchDefinitionFromJSONTyped(json: any, ignoreDiscriminator: boolean): PatchDefinition {
    if (json == null) {
        return json;
    }
    return {
...
export function PatchDefinitionToJSON(json: any): PatchDefinition {
    return PatchDefinitionToJSONTyped(json, false);
}

export function PatchDefinitionToJSONTyped(value?: PatchDefinition | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
