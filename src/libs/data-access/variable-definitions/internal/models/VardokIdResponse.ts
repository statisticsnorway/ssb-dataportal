 ...
 * 
 * @export
 * @interface VardokIdResponse
 */
export interface VardokIdResponse {
    /**
     * 
     * @type {string}
     * @memberof VardokIdResponse
     */
    vardokId: string;
}

/**
 * Check if a given object implements the VardokIdResponse interface.
 */
export function instanceOfVardokIdResponse(value: object): value is VardokIdResponse {
    if (!('vardokId' in value) || value['vardokId'] === undefined) return false;
    return true;
}

export function VardokIdResponseFromJSON(json: any): VardokIdResponse {
    return VardokIdResponseFromJSONTyped(json, false);
}

export function VardokIdResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): VardokIdResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function VardokIdResponseToJSON(json: any): VardokIdResponse {
    return VardokIdResponseToJSONTyped(json, false);
}

export function VardokIdResponseToJSONTyped(value?: VardokIdResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
