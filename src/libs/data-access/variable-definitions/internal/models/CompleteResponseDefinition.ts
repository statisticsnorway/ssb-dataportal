 ...
 * @export
 * @interface CompleteResponseDefinition
 */
export interface CompleteResponseDefinition {
    /**
     * Norwegian Bokmål
     * @type {string}
     * @memberof CompleteResponseDefinition
     */
    nb?: string | null;
    /**
     * Norwegian Nynorsk
...
/**
 * Check if a given object implements the CompleteResponseDefinition interface.
 */
export function instanceOfCompleteResponseDefinition(value: object): value is CompleteResponseDefinition {
    return true;
}

export function CompleteResponseDefinitionFromJSON(json: any): CompleteResponseDefinition {
    return CompleteResponseDefinitionFromJSONTyped(json, false);
}

export function CompleteResponseDefinitionFromJSONTyped(json: any, ignoreDiscriminator: boolean): CompleteResponseDefinition {
    if (json == null) {
        return json;
    }
    return {
...
export function CompleteResponseDefinitionToJSON(json: any): CompleteResponseDefinition {
    return CompleteResponseDefinitionToJSONTyped(json, false);
}

export function CompleteResponseDefinitionToJSONTyped(value?: CompleteResponseDefinition | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
