...
/**
 * Check if a given object implements the PatchName interface.
 */
export function instanceOfPatchName(value: object): value is PatchName {
    return true;
}

export function PatchNameFromJSON(json: any): PatchName {
    return PatchNameFromJSONTyped(json, false);
}

export function PatchNameFromJSONTyped(json: any, ignoreDiscriminator: boolean): PatchName {
    if (json == null) {
        return json;
    }
    return {
...
export function PatchNameToJSON(json: any): PatchName {
    return PatchNameToJSONTyped(json, false);
}

export function PatchNameToJSONTyped(value?: PatchName | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
