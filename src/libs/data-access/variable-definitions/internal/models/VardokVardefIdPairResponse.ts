 ...
 * 
 * @export
 * @interface VardokVardefIdPairResponse
 */
export interface VardokVardefIdPairResponse {
    /**
     * 
     * @type {string}
     * @memberof VardokVardefIdPairResponse
     */
    vardokId: string;
    /**
     * 
...
/**
 * Check if a given object implements the VardokVardefIdPairResponse interface.
 */
export function instanceOfVardokVardefIdPairResponse(value: object): value is VardokVardefIdPairResponse {
    if (!('vardokId' in value) || value['vardokId'] === undefined) return false;
    if (!('vardefId' in value) || value['vardefId'] === undefined) return false;
    return true;
}

export function VardokVardefIdPairResponseFromJSON(json: any): VardokVardefIdPairResponse {
    return VardokVardefIdPairResponseFromJSONTyped(json, false);
}

export function VardokVardefIdPairResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): VardokVardefIdPairResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'vardokId': json['vardok_id'],
        'vardefId': json['vardef_id'],
    };
}

export function VardokVardefIdPairResponseToJSON(json: any): VardokVardefIdPairResponse {
    return VardokVardefIdPairResponseToJSONTyped(json, false);
}

export function VardokVardefIdPairResponseToJSONTyped(value?: VardokVardefIdPairResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'vardok_id': value['vardokId'],
        'vardef_id': value['vardefId'],
    };
}
