...
/**
 * Check if a given object implements the PatchOwner interface.
 */
export function instanceOfPatchOwner(value: object): value is PatchOwner {
    if (!('team' in value) || value['team'] === undefined) return false;
    if (!('groups' in value) || value['groups'] === undefined) return false;
    return true;
}

export function PatchOwnerFromJSON(json: any): PatchOwner {
    return PatchOwnerFromJSONTyped(json, false);
}

export function PatchOwnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): PatchOwner {
    if (json == null) {
        return json;
    }
    return {
...
export function PatchOwnerToJSON(json: any): PatchOwner {
    return PatchOwnerToJSONTyped(json, false);
}

export function PatchOwnerToJSONTyped(value?: PatchOwner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
