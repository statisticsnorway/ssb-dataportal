 ...
 * Contact details
 * @export
 * @interface CompleteResponseContact
 */
export interface CompleteResponseContact {
    /**
     * 
     * @type {LanguageStringType}
     * @memberof CompleteResponseContact
     */
...
/**
 * Check if a given object implements the CompleteResponseContact interface.
 */
export function instanceOfCompleteResponseContact(value: object): value is CompleteResponseContact {
    if (!('title' in value) || value['title'] === undefined) return false;
    if (!('email' in value) || value['email'] === undefined) return false;
    return true;
}

export function CompleteResponseContactFromJSON(json: any): CompleteResponseContact {
    return CompleteResponseContactFromJSONTyped(json, false);
}

export function CompleteResponseContactFromJSONTyped(json: any, ignoreDiscriminator: boolean): CompleteResponseContact {
    if (json == null) {
        return json;
    }
    return {
...
export function CompleteResponseContactToJSON(json: any): CompleteResponseContact {
    return CompleteResponseContactToJSONTyped(json, false);
}

export function CompleteResponseContactToJSONTyped(value?: CompleteResponseContact | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
