 ...
 * 
 */
export class PatchesApi extends runtime.BaseAPI {

    /**
     * Create a new patch for a variable definition.
     * Create a new patch for a variable definition.
     */
    async createPatchRaw(requestParameters: CreatePatchRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CompleteResponse>> {
        if (requestParameters['variableDefinitionId'] == null) {
            throw new runtime.RequiredError(
                'variableDefinitionId',
                'Required parameter "variableDefinitionId" was null or undefined when calling createPatch().'
            );
        }
        ...
        if (requestParameters['validFrom'] != null) {
            queryParameters['valid_from'] = (requestParameters['validFrom'] as any).toISOString().substring(0,10);
        }
        ...
        let urlPath = `/variable-definitions/{variable-definition-id}/patches`;
        ...
        const response = await this.request({
            ...
            body: PatchToJSON(requestParameters['patch']),
        }, initOverrides);
     ...
     * Create a new patch for a variable definition.
     */
    async createPatch(requestParameters: CreatePatchRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CompleteResponse> {
        const response = await this.createPatchRaw(requestParameters, initOverrides);
     ...
     */
    async getPatchRaw(requestParameters: GetPatchRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CompleteResponse>> {
        if (requestParameters['variableDefinitionId'] == null) {
            throw new runtime.RequiredError(
                'variableDefinitionId',
                'Required parameter "variableDefinitionId" was null or undefined when calling getPatch().'
            );
        }

        if (requestParameters['patchId'] == null) {
            throw new runtime.RequiredError(
                'patchId',
                'Required parameter "patchId" was null or undefined when calling getPatch().'
            );
        }
        ...
        let urlPath = `/variable-definitions/{variable-definition-id}/patches/{patch-id}`;
        urlPath = urlPath.replace(`{${"variable-definition-id"}}`, encodeURIComponent(String(requestParameters['variableDefinitionId'])));
        urlPath = urlPath.replace(`{${"patch-id"}}`, encodeURIComponent(String(requestParameters['patchId'])));
     ...
     * Get one concrete patch for the given variable definition.
     */
    async getPatch(requestParameters: GetPatchRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CompleteResponse> {
        const response = await this.getPatchRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async listPatchesRaw(requestParameters: ListPatchesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<CompleteResponse>>> {
        if (requestParameters['variableDefinitionId'] == null) {
            throw new runtime.RequiredError(
                'variableDefinitionId',
                'Required parameter "variableDefinitionId" was null or undefined when calling listPatches().'
            );
        }
     ...
     * List all patches for the given variable definition.
     */
    async listPatches(requestParameters: ListPatchesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<CompleteResponse>> {
        const response = await this.listPatchesRaw(requestParameters, initOverrides);
        return await response.value();
    }
