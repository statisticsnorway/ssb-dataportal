...
import {
    ...
    ProblemFromJSON,
    ProblemToJSON,
    ValidityPeriodFromJSON,
    ValidityPeriodToJSON,
} from '../models/index';

export interface CreateValidityPeriodRequest {
    variableDefinitionId: string;
    validityPeriod?: ValidityPeriod;
}

export interface ListValidityPeriodsRequest {
    variableDefinitionId: string;
}
...
export class ValidityPeriodsApi extends runtime.BaseAPI {
     ...
     * Create a new validity period for a variable definition.
     */
    async createValidityPeriodRaw(requestParameters: CreateValidityPeriodRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CompleteResponse>> {
        if (requestParameters['variableDefinitionId'] == null) {
            throw new runtime.RequiredError(
                'variableDefinitionId',
                'Required parameter "variableDefinitionId" was null or undefined when calling createValidityPeriod().'
            );
        }
        ...
        let urlPath = `/variable-definitions/{variable-definition-id}/validity-periods`;
        ...
        const response = await this.request({
            ...
            body: ValidityPeriodToJSON(requestParameters['validityPeriod']),
        }, initOverrides);
     ...
     * Create a new validity period for a variable definition.
     */
    async createValidityPeriod(requestParameters: CreateValidityPeriodRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CompleteResponse> {
        const response = await this.createValidityPeriodRaw(requestParameters, initOverrides);
     ...
     * List all validity periods.
     */
    async listValidityPeriodsRaw(requestParameters: ListValidityPeriodsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<CompleteResponse>>> {
        if (requestParameters['variableDefinitionId'] == null) {
            throw new runtime.RequiredError(
                'variableDefinitionId',
                'Required parameter "variableDefinitionId" was null or undefined when calling listValidityPeriods().'
            );
        }
     ...
     * List all validity periods.
     */
    async listValidityPeriods(requestParameters: ListValidityPeriodsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<CompleteResponse>> {
        const response = await this.listValidityPeriodsRaw(requestParameters, initOverrides);
        return await response.value();
    }
