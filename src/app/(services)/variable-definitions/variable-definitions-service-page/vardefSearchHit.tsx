    ...
    <Card>
      <Heading data-size='xl' level={1}>
        <Link
          ...
          className='vardef-search-hit__heading-link'
        >
          <span className='vardef-search-hit__name'>{variableDefinition.name.nb}</span>
          {variableDefinition.shortName && (
            <span className='vardef-search-hit__short-name'>{variableDefinition.shortName}</span>
          )}
        </Link>
      </Heading>
