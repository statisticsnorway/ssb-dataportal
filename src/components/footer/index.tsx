  ...
  return (
    <footer className={styles.footer}>
      <section className={styles.footerLinkSection}>
        <Heading level={4} className={'negative-text'}>
          {localization.appTitle}
        </Heading>
        <p className={'negative-text'}>{localization.info.landingPageSubTitle}</p>
      </section>
      <section className={styles.footerLinkSection}>
        <Heading level={4} className={'negative-text'}>
        ...
        <FooterLinkItem
          icon={<ShieldLockIcon title={localization?.contact?.label} fontSize='2rem' className={styles.negativeLink} />}
        >
          <ExternalLink
