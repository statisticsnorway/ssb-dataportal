...
- Skills for this project are stored in `.agents/skills`

### Playwright

- `playwright-cli` (`.agents/skills/playwright-cli`): use for browser automation and fast UI checks (open pages, inspect snapshots, click through flows, debug Playwright behavior).
